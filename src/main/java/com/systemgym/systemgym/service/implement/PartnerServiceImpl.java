...
public class PartnerServiceImpl implements IPartnerService {
    ...
    public ResponsePartnerDTO findByIdPartner(Integer id) throws Exception {
        ...
        Partner objPartner = iPartnerRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Partner not found"));
    ...
    public ResponsePartnerDTO updatePartner(Integer id, UpdatePartnerDTO updatePartnerDTO) throws Exception {
        ...
        Partner partnerEntity = iPartnerRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Partner not found"));
